...
<html>
	...
	<
		...
		<b>SMP Kelas 8</b><br>
		<p><b>SMP Santa Laurensia</b><br></p>
		di Tempat
		<p>Salam sejahtera,</p>
		...
		<p>Dalam kesempatan ini, kami ingin memberitahukan bahwa anak Bapak/Ibu:</p>
			...
			<table style="border:0 !important;margin-left:50px">
				<tr>
					...
					<td>:</td>
					<td><span style="font-weight: bold;text-transform: uppercase;">alldrich putra s</span></td>
				</tr>
				<tr>
					<td>No. Peserta</td>
					<td>:</td>
					<td><span style="font-weight: bold;">1020831003</span></td>
				</tr>
				<tr>
					<td>Kelas</td>
					<td>:</td>
					<td><span style="font-weight: bold">SMP Kelas 8</span></td>
				</tr>
				<tr>
					<td>Grade Nilai</td>
					<td>:</td>
					<td><span style="font-weight: bold">C</span></td>
				</tr>
			</table>
